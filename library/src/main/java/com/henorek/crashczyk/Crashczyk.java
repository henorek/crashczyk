...
import com.henorek.crashczyk.activity.DefaultErrorActivity;
...
@SuppressLint("NewApi")
public final class Crashczyk {

    //Extras passed to the error activity
    private static final String EXTRA_RESTART_ACTIVITY_CLASS = "com.henorek.crashczyk.EXTRA_RESTART_ACTIVITY_CLASS";
    private static final String EXTRA_SHOW_ERROR_DETAILS = "com.henorek.crashczyk.EXTRA_SHOW_ERROR_DETAILS";
    private static final String EXTRA_STACK_TRACE = "com.henorek.crashczyk.EXTRA_STACK_TRACE";
    private static final String EXTRA_IMAGE_DRAWABLE_ID = "com.henorek.crashczyk.EXTRA_IMAGE_DRAWABLE_ID";

    //General constants
    private final static String TAG = "Crashczyk";
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.henorek.crashczyk.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.henorek.crashczyk.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "com.henorek.crashczyk";
    ...
    private static int defaultErrorActivityDrawableId = R.drawable.crashczyk_error_image;
    ...
    /**
     * Installs Crashczyk on the application using the default error activity.
     *
        ...
        try {
            if (context == null) {
                ...
                if (android.os.Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                    Log.w(TAG, "Crashczyk will be installed, but may not be reliable in API lower than 14");
                }
                ...
                if (oldHandler != null && oldHandler.getClass().getName().startsWith(CAOC_HANDLER_PACKAGE_NAME)) {
                    Log.e(TAG, "You have already installed Crashczyk, doing nothing!");
                } else {
                    if (oldHandler != null && !oldHandler.getClass().getName().startsWith(DEFAULT_HANDLER_PACKAGE_NAME)) {
                        Log.e(TAG, "IMPORTANT WARNING! You already have an UncaughtExceptionHandler, are you sure this is correct? If you use ACRA, Crashlytics or similar libraries, you must initialize them AFTER Crashczyk! Installing anyway, but your original handler will not be called.");
                    }
                    ...
                    Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            Log.e(TAG, "App has crashed, executing Crashczyk's UncaughtExceptionHandler", throwable);
                    ...
                    Log.i(TAG, "Crashczyk has been installed.");
                }
            }
        } catch (Throwable t) {
            Log.e(TAG, "An unknown error occurred while installing Crashczyk, it may not have been properly initialized. Please report this as a bug if needed.", t);
        }
    }
    ...
    public static boolean isShowErrorDetailsFromIntent(Intent intent) {
        return intent.getBooleanExtra(Crashczyk.EXTRA_SHOW_ERROR_DETAILS, true);
    }
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(Crashczyk.EXTRA_IMAGE_DRAWABLE_ID, R.drawable.crashczyk_error_image);
    }
    ...
    public static String getStackTraceFromIntent(Intent intent) {
        return intent.getStringExtra(Crashczyk.EXTRA_STACK_TRACE);
    }
    ...
    public static Class<? extends Activity> getRestartActivityClassFromIntent(Intent intent) {
        Serializable serializedClass = intent.getSerializableExtra(Crashczyk.EXTRA_RESTART_ACTIVITY_CLASS);
    ...
    public static void setLaunchErrorActivityWhenInBackground(boolean launchErrorActivityWhenInBackground) {
        Crashczyk.launchErrorActivityWhenInBackground = launchErrorActivityWhenInBackground;
    }
    ...
    public static void setShowErrorDetails(boolean showErrorDetails) {
        Crashczyk.showErrorDetails = showErrorDetails;
    }
     ...
     * The default is R.drawable.crashczyk_error_image (a cute upside-down bug).
     */
    public static void setDefaultErrorActivityDrawable(int defaultErrorActivityDrawableId) {
        Crashczyk.defaultErrorActivityDrawableId = defaultErrorActivityDrawableId;
    }
    ...
    public static void setEnableAppRestart(boolean enableAppRestart) {
        Crashczyk.enableAppRestart = enableAppRestart;
    }
    ...
    public static void setErrorActivityClass(Class<? extends Activity> errorActivityClass) {
        Crashczyk.errorActivityClass = errorActivityClass;
    }
    ...
    public static void setRestartActivityClass(Class<? extends Activity> restartActivityClass) {
        Crashczyk.restartActivityClass = restartActivityClass;
    }
    ...
    private static Class<? extends Activity> guessRestartActivityClass(Context context) {
        ...
        resolvedActivityClass = Crashczyk.getRestartActivityClassWithIntentFilter(context);
    ...
    private static Class<? extends Activity> guessErrorActivityClass(Context context) {
        ...
        //If action is defined, use that
        resolvedActivityClass = Crashczyk.getErrorActivityClassWithIntentFilter(context);
