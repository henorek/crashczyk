...
//        Crashczyk.setLaunchErrorActivityWhenInBackground(false);
...
//        Crashczyk.setRestartActivityClass(MainActivity.class);

        //This hides the "error details" button in the error activity, thus hiding the stack trace
//        Crashczyk.setShowErrorDetails(false);
...
//        Crashczyk.setEnableAppRestart(false);
...
//        Crashczyk.setDefaultErrorActivityDrawable(R.mipmap.ic_launcher);
...
//        Crashczyk.setErrorActivityClass(CustomErrorActivity.class);

        //This enables Crashczyk
